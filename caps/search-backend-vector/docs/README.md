# search.backend.vector — Contract Only

This package defines contracts for a vector indexing/search backend capability:
- triRPC service surface (rpc/vector.index.v0.yaml)
