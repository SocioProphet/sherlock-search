# search.backend.graph — Contract Only

This package defines contracts for a graph reasoning/search backend capability:
- triRPC service surface (rpc/graph.reason.v0.yaml)
